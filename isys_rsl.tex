...
% --- Autoria identificada (single-blind). ORCID é OBRIGATÓRIO por autor. ---
% TODO: preencher ORCID, afiliação e e-mail reais (placeholders abaixo).
% TODO: confirmar a lista de autores (ver perguntas ao final da entrega).
\author[Oliveira et al. 202X]{
\affil{\textbf{Ana Beatriz Carvalho Oliveira}~\orcidlink{0000-0000-0000-0000}~\textcolor{blue}{\faEnvelopeO}~~[{Universidade Federal de Sergipe}~|\href{mailto:TODO@exemplo.br}{~{\textit{TODO@exemplo.br}}}~]}

\affil{\textbf{Gilton José Ferreira da Silva}~\orcidlink{0000-0000-0000-0000}~~[{Universidade Federal de Sergipe}~|\href{mailto:TODO@exemplo.br}{{\textit{TODO@exemplo.br}}}~]}
}
...
\begin{mail}
% TODO: endereço de correspondência do autor (single-blind).
Universidade Federal de Sergipe -- Departamento/Programa, Cidade -- UF, Brasil.
\end{mail}
