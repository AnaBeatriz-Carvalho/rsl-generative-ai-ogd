...
\begin{itemize}
    ...
    \item Fornece rastreabilidade: o chatbot recupera um subconjunto de registros da base, cita-os na resposta por identificador estável e expõe, na interface, o painel de fontes utilizadas
\end{itemize}
