...
\begin{itemize}
    ...
    \item \textbf{Motor de Resposta (RAG Simplificado):} O módulo recebe perguntas do usuário em linguagem natural, recupera dados relevantes da base em memória (cache de sessão) e instrui o modelo Mistral 7B a gerar respostas contextualizadas e didáticas que sejam compreensíveis para cidadãos não-especialistas.
\end{itemize}
