...
É importante registrar uma limitação do próprio mapeamento: o corpus de 7 estudos primários selecionados é pequeno para afirmações categóricas sobre o estado da área, e a forte concentração de retornos em uma única base (ACM Digital Library) pode enviesar as lacunas identificadas, que devem, portanto, ser lidas como indícios e não como conclusões definitivas. Essa limitação pode refletir tanto a emergência da temática quanto restrições das \textit{strings} de busca utilizadas. Para mitigá-la, está prevista, antes da defesa, a ampliação da busca por \textit{snowballing} --- para frente e para trás --- a partir dos estudos incluídos, além de busca complementar manual (incluindo a biblioteca digital da SBC e o Google Scholar) e da documentação, em apêndice, das \textit{strings} exatas aplicadas em cada base, com os respectivos números de retorno e filtros --- requisitos para a plena reprodutibilidade do mapeamento, conforme as diretrizes de Kitchenham \cite{Kitchenham2004}.
