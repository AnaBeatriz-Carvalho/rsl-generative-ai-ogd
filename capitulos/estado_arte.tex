...
\textbf{Conexão com Este Trabalho:} Este trabalho dialoga com LegisFlow ao adaptar a ideia de consulta conversacional para o contexto brasileiro/português, combinando agente conversacional com \textit{dashboard} visual e avaliação técnica de respostas baseadas em dados parlamentares.
...
É importante registrar uma limitação do próprio mapeamento: o corpus de 7 estudos primários selecionados é pequeno para afirmações categóricas sobre o estado da área, o que pode refletir tanto a emergência da temática quanto eventuais restrições das \textit{strings} de busca utilizadas. Futuras iterações desta pesquisa poderiam ampliar a busca com \textit{snowballing} a partir dos estudos incluídos, capturando trabalhos relevantes não indexados nas bases consultadas.
