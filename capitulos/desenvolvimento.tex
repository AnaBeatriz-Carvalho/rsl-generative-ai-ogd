...
\begin{itemize}
    ...
    \item \textbf{Motor de Resposta (RAG Simplificado):} O módulo recebe perguntas do usuário em linguagem natural via Chatbot, recupera dados relevantes da base em memória (usando busca estruturada por palavras-chave sobre os dados mantidos em cache de sessão), e instrui o Mistral 7B a gerar respostas contextualizadas, didáticas e alinhadas aos dados reais.
\end{itemize}
