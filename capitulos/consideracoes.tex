...
\begin{enumerate}
    \item \textbf{Conhecimento sobre Design de Interfaces para Acessibilidade de Dados Legislativos:} Investigação empiricamente fundamentada de como combinar múltiplas modalidades (Dashboard visual + Chatbot conversacional) melhora acesso democrático a informação.
